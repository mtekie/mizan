...
export function getProfileCompletion(user: Partial<Record<ProfileField, unknown>>) {
...
export function isCoreProfileComplete(user: Partial<Record<ProfileField, unknown>>) {
